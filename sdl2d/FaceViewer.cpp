/*I did find a way to make other shapes, but it 
 * takes a decent bit of work with a texture and 
 * a circle drawing algorithm so I just called it on this for now...
 * And yes I realize this submission is exceedingly late
 * to build this with gcc do g++ FaceViewer.cpp -o FV -lSDL2
 * after that run FV.
 * -Mike, 11/9/21
 */
...
int main(){
	...
	SDL_Window *win = SDL_CreateWindow("This is a window title :)",SDL_WINDOWPOS_CENTERED,SDL_WINDOWPOS_CENTERED,640,480,0);
	if(!win){
